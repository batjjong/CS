...
namespace Week09Homework
{
    ...
    public partial class FormManager : Form
    {
        ...
        public static string DepartmentFullFileName
        {
            get {
        ...
        public static string ProfessorFullFileName
        {
            get
            {
        ...
        public static string StudentFullFileName
        {
            get
            {
        ...
        //public static string StudentFullFileName = Path.Combine(PATH, "student.txt");
        ...
        private void SaveInfo(IFile professor, string filename)
        {
            using (var fs = new FileStream(filename, FileMode.Append))
            {
                using (var sw = new StreamWriter(fs))
        ...
        {
            using (var fs = new FileStream(filename, FileMode.Create)) {//열기
                using (var sw = new StreamWriter(fs)) {
                    foreach (var prof in professors) {
                        sw.WriteLine(prof.Record);
                    }
